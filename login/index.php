			...
			<div class="col-md-auto login-box borde sombra">
				...
				<form id="frmIngreso">
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-12">
		              			<input  data-size="small" data-style="android" value="<?php echo "$valor"; ?>" type="checkbox" <?php echo "$checado"; ?>  id="<?php echo "interruptor".$n; ?>"  data-toggle="toggle" data-on="Cambiar Contraseña" data-off="Cambiar Contraseña" data-onstyle="success" data-offstyle="danger" class="interruptor" data-width="200" onchange="status(<?php echo $n; ?>,<?php echo $idUsuario; ?>);">
